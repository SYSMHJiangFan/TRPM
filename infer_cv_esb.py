...
def main():
    ...
    parser.add_argument('--input_model_rec_path', default=None, type=str, help='input_label_info_dict')
    ...
    # init models
    model_path_list = pd.read_csv(args.input_model_rec_path)['best_model'].tolist()
    ...
    pd.DataFrame(output_content_dict).to_csv(save_path, index=False)
